        ...
        <div className="sn-card">
          ...
          <div className="h-80 w-full flex items-center justify-center relative">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
              <span className="text-4xl font-bold text-sn-dark">
                {slaData.length > 0 ? Math.round((slaData[0].value / (slaData[0].value + slaData[1].value)) * 100) : 0}%
              </span>
          ...
          <div className="flex justify-center gap-8 mt-4">
            {slaData.map((entry, index) => (
              <div key={entry.name} className="flex items-center gap-2">
                <div className="w-3 h-3 rounded-full" style={{ backgroundColor: SLA_COLORS[index % SLA_COLORS.length] }} />
